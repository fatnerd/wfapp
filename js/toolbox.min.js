...
function fillListwPos(c){$("#mainload").text("\u6b63\u5728\u5448\u73b0\u5230\u5217\u8868\u4e0a......");setTimeout(function(){var b=document.createDocumentFragment(),a;for(a in c){var d=document.createElement("li"),e=document.createElement("a");e.innerHTML=c[a].id+". "+c[a].name+"&nbsp;&nbsp;&nbsp;&nbsp;\u5269 "+c[a].availBike+" / "+(c[a].capacity-c[a].availBike)+" \u7a7a";var f=document.createElement("a");f.setAttribute("class","splbutton");f.setAttribute("arrayid",ibike.station[a].id-1);d.appendChild(e);
d.appendChild(f);b.appendChild(d)}document.getElementById("mainlist").innerHTML="";document.getElementById("mainlist").appendChild(b);$("#mainlist").listview("refresh");hideload("mainload")},5)}
function fillListwoPos(){$("#mainload").text("\u6b63\u5728\u5448\u73b0\u5230\u5217\u8868\u4e0a......");setTimeout(function(){var c=document.createDocumentFragment(),b;for(b in ibike.station){var a=document.createElement("li"),d=document.createElement("a");d.innerHTML=ibike.station[b].id+". "+ibike.station[b].name+"&nbsp;&nbsp;&nbsp;&nbsp;\u5269 "+ibike.station[b].availBike+" / "+(ibike.station[b].capacity-ibike.station[b].availBike)+" \u7a7a";var e=document.createElement("a");e.setAttribute("class",
"splbutton");e.setAttribute("arrayid",ibike.station[b].id-1);a.appendChild(d);a.appendChild(e);c.appendChild(a)}document.getElementById("mainlist").innerHTML="";document.getElementById("mainlist").appendChild(c);$("#mainlist").listview("refresh");hideload("mainload")},5)};